 ...
 * @author manana
 */
public class ShopView extends JFrame implements KeyListener {
   ...
   public ShopView() {
    ...
    private void openProductView() {
        ...
        JDialog dialog = new JDialog(this, "Producto", true);
        dialog.setContentPane(productView); // Aquí es donde se agrega directamente productView
        dialog.pack();
    ...
    private void openStockView(){
        StockView stockView = new StockView(shop);
        JDialog dialog = new JDialog(this, "Producto", true);
        dialog.setContentPane(stockView); // Aquí es donde se agrega directamente stockView
        dialog.pack();
        dialog.setLocationRelativeTo(null);
        dialog.setVisible(true);
    }
